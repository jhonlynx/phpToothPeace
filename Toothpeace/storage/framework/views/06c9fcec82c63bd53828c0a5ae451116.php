...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('pics/toothpeace_logo.png')); ?>" type="image/x-icon">
    <link rel="stylesheet" href="<?php echo e(asset('css/landing.css')); ?>">
    <script src="<?php echo e(asset('js/jslanding.js')); ?>"></script>
...
<body>
    <header>
        <div class="logo">
            <img src="<?php echo e(asset('pics/toothpeace_logo.png')); ?>" alt="ToothPeace Logo" />
        </div>
    </header>
...
<?php /**PATH C:\Users\Jhon Paul\Downloads\ToothPeace\ToothPeace-master\resources\views/index.blade.php ENDPATH**/ ?>